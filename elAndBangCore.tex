...
\martin{Why do we not allow $\lambda(s)$ to be an arbitrary subset of
  $\Sigma$?  What goes wrong if we do? Why do we need the possibility
  that $\Sigma(s) = \Sigma$?}
\end{definition}
...
predicate $\RESTRICTTWO{}{\cdot}{\cdot}$ and a ternary predicate
$\ARROWTHREE{}{\cdot}{\cdot}{\cdot}$. The intended interpretation
