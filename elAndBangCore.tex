\section{Inference rules, completeness and compactness for eremic logic}\label{coreEL}

In this section we produce our key results. 
We provide inference rules for \ELABR{}, establish completeness of the 
...
\martin{Add some more example assertions here, for example some
...
\martin{Don't we need to prove these lemmas?}
