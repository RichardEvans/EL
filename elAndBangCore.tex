...
unique (up to isomorphism) simplest\footnote{The ``simplest'' model is the least upper bound according to the $\MODELLEQ$ relation.} model satisfying a formula. Any
...
We shall rely on this property to provide a quadratic-time decision procedure and to prove the completeness of our inference rules.
...
incompatibility semantics constraint for \cathoristic, we need to
