...
\item ... (something with a simulation on the underliyng LTS and a condition on $\lambda$s)
...
Bisimilarity is defined likewise for models. \martin{should we break
  up this definition into several smaller parts?}
\end{definition}
