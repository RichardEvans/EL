...
\subsection{The logic $CL[\land, !, \neg]$}

Our motivation for investigating \cathoristic{} has been to give an
alternative account of negation, based on the concept of exclusion.
In this section we study how to recover negation in \cathoristic{}. For
this purpose, we enrich \cathoristic{} with negation as well as
disjunction, and show how negation can be explained in terms of plain
\cathoristic{} with disjunction.

\begin{definition}
Given a set $\Sigma$ of symbols, the \emph{formulae of \cathoristic{}
  with negation}, collectively denoted CL$[\land, !, \neg]$, are given
...
The semantics of CL$[\land, !, \neg]$ is just as in CL$[\land, !]$
...
\NI We can use the fact that the $[\land, \fBang]$ fragment of SNEL\martin{That term is now obsolete.}
has a quadratic-time decision procedure to build an exponential-time
