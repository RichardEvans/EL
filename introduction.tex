...
This paper introduces an alternative, \ELFULL{}, where incompatibility is
...
\]
Crucially \ELFULL{}'s representation involves no
...
easily expressed in first-order logic\footnote{We will precisify this
  ...
  incompatibility is longer in terms of formula length than \ELFULL{}'s (see
...
In this subsection, we shall describe \emph{other} inferential relations between atomic sentences - inferential relations that \fol cannot articulate, but that \ELFULL{} handles naturally.
