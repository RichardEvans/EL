...
\[
   !\{green, amber, red\} \AND \MAY{amber}{}
\]
expresses that $amber$ is currently the case and $red$ as well as $green$ are the
only two possible alternatives to $amber$.

Any statement that exceeds what tantum $A$ allows, like
\[
...
propositional representation of exclusion.
