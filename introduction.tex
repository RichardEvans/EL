...
Brandom \cite{brandom2}, following suggestions by Sellars, Hegel and
Kant, proposes an alternative explanation: ``Jack is male'' is
incompatible with ``Jack is female'' because ``is male'' and ``is
female'' are \emph{incompatible predicates}.  He claims that we can
understand incompatible predicates even if we do not understand
universal quantification or negation.  In summary: 
