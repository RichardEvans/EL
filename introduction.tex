...
equivalence\footnote{This equivalence is described in \cite{brandom2}:
  ...
  Appendices.\martin{should we change the $p$ and $q$ here to $\phi, \psi$ etc?}}:
...
$n\cdot C^p_2$ facts to learn\martin{what is $C_2$?}.  This quickly becomes impractical as $n$ and
