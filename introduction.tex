...
primordial language of atomic sentences\footnote{See Section \ref{intrasentential} below for a characterisation of the atomic sentences.}\martin{why do we
make a forward reference for this but not for a lot of other concepts?}. These people can express
...
We do not need negation to make sense of exclusion.\martin{I still think this paragraphs is not integrated iwth the rest: it introduces
the concept of complex connectives ex nihilo, and the subsequent paragraphs dont even 
mention it. It also introduces high-tech termin ology like ``least upper bound'' that are
in stark contrast to the intuitive, non-technical language used in the rest of the introduction. Even the
``If this picture of our primordial language is coherent ...'' doesn't really tie the prinmitive language
together with  complex operators}
