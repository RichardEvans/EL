...
will now argue that exclusion is conceptually prior to negation and
enables us to express intra-sentential logical concepts such as
inference from $n+1$-ary to $n$-ary relations and intra-sentential
inferential, all of which are expensive in first-order logic.
