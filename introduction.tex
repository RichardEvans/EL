...
so. Section 2 introduces the syntax and sem,antics of EL, Sections 3
and 4 da da da, In section 4 ...  We should also say something along
the lines of: A Haskell implementation of the decision procedure can
be found in \cite{HaskellImplementation}.}  The rest of this paper is
