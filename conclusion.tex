...
\end{quote}
Brandom sees this as a rearticulation of Kant's project in the First Critique:
\begin{quote}
The account of feedback loops of perception-and-performance normatively governed by relations of material inference and incompatibility is a pragmatic version of Kant's account of synthesising a transcendental unity of apperception\footnote{\cite{brandom} p.187.}.
\end{quote}
...
\richard{Personally, I would like to delete this paragraph. It seems a little vague, and we mention the roots of the Sellars/Brandom view elsewhere.}
