...
\Cathoristic{} is a simple logic of atomic sentences.
...
\Cathoristic{} is an attempt to formalise Sellars' and Brandom's view that material incompatibility is conceptually prior to logical negation.

In this paper, we have defined \cathoristic{} as a multi-modal logic based on
exclusion as a logical primitive. 
We have investigated key
meta-theoretic properties of the logic, related \cathoristic{} to
...
\Cathoristic{} started as an attempt to formalise the Sellars/Brandom idea that material incompatibility is conceptually prior to logical negation.
