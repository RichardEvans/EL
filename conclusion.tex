...
\NI We have proposed eremic logic, a multi-modal logic based on
...
and the semantics of concurrent processes. We end this paper with a
...
develops that concept, in part in reaction to Kant's use
