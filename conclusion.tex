...
\richard{The reason I included it is to strengthen the claim that incompatibility is a fundamental notion: it is according to Hegel/Sellars/Brandom the fundamental master-concept from which objects and agents arise. Do you think we should delete it??}\martin{I don't
think the conclusion should argue anything about the paper. If we need to bolster 
the imporance of incompatibility, then I suggest to add it to the introduction.
Alternatively, we could pitch it as futher work: this paper shows that 
we get somnething very interesting from the notion of incompatibitlity, and
Hegel/Sellars/Brandom use incompatibility for X, Y, and Z, then maybe 
we we should also look at X, Y and Z. But we don't really need more about Incompatibility as a Fundamental Semantic Relation in
terms of related work.}
