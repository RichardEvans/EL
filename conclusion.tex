figure:elAndBang:models.tex
figure:elSmall.tex1;2c
...
other\martin{Have we defined incompatibility of PL/HML?}\richard{No, but it is just the same as before: a set of sentences is incompatible if there is no model that satisfies them all.}\martin{Maybe short note to that effect? Or bibliographic reference?}.  But many
