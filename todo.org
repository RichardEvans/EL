...
* TODO  Be clear about tantum and available vs permitted:
...
* TODO Make references to versu in biblio OK
* TODO Set up own github repo for Haskell code, put in proper references.
Put in license and documentation (sparse)
...
* TODO Make a clear point somewhere that tree models are
all we need.
...
\footnote{Itself a development of Sellars,
  Hegel and Kant.}
* TODO Add all missing biblographic references
