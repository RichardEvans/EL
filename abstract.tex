...
Because it does not have complexifying logical operators ($\neg$, $\lor$, or $\Rightarrow$), \ELFULL{} has a \emph{linear-time decision procedure}.
...
We show that the syntactic notion of elementary equivalence induced by the the formulae of \ELFULL{} coincides with the semantic notion of mutual simulation on models.  
