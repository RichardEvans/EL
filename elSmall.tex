...
that satisfy $a \in A$ are available.
...
stated otherwise.
\richard{Can we get rid of this? It doesn't seem super-necessary to me.}
\martin{I think it's quite important, because we never mention $\Sigma$ explicitly in what follows.
A mathematically inclined review is likely to complain about it. So the convention
forestalls stupid complaints.}
\end{convention}
...
node is the start state.  The same model does not satisfy any of the
following formulae.
\[
\MAY{b} \qquad
\fBang \{a\} \qquad
