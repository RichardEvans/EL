...
sectino?}
\richard{For now, I have just removed the reference to Propositional Logic in the section heading. I am not sure where we should place this section. We could place it in the conclusion (in the part where we compare CL to various other logics?)}
