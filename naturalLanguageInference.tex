...
\NI Entailment from dyadic to monadic predicates\footnote{Although
...
\martin{I suggest to drop the summary since it just repeats what we just said. Instead
we should just talk about the inferences that CL cannot do.} 
