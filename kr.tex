...
In this section, we are assuming a \emph{deterministic} Labelled Transition System. So we cannot have $\MAY{a} ! \{\} \land \MAY{a}\MAY{b}$ because there is at most one $a$-transition from any state.
...
<a> <r> <b>
\end{verbatim}
But a sentence involving a many-to-one two-place relation of the form $r(a,b)$ is expressed in \ELABR{}\footnote{We are assuming a \emph{deterministic} labelled transition system throughout this section.}:
\begin{verbatim}
<a> <r> (<b> /\ !{b})
\end{verbatim}
...
\subsection{Advantages of \ELABR{} over Predicate Logic}
