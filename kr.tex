...
``contained'' within the object.  \martin{Isn't that just a
  presentational detail? I think we can drop it.}  But we \emph{could}
...
\martin{I think we can drop this subsection header.}
