...
models for \cathoristic{}. The purpose of the node labels was to express
...
\begin{definition}
By a \emph{pure cathoristic model}, ranged over by $\PPP, \PPP', ...$, we
...
with respect to the new semantics too\martin{what about
  completeness?}.  The key advantage pure cathoristic models have is their
...
equivalence on (finitely branching) pure cathoristic models is
...
about cathoristic models. The reason is one of philosophy: on pure cathoristic
models, \cathoristic{} can distinguish models based on branching
...
\subsection{A semantic characterisation of elementary equivalence for pure cathoristic models}
...
\subsection{Non-deterministic \cathoristic{} cannot express incompatibility}
