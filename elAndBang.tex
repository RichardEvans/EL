...
\NI Given a set $\mathcal{S}$ of symbols, with $a$ ranging over
$\mathcal{S}$, and $A$ ranging over finite subsets of $\mathcal{S}$,
the sentences of EL$[\land, !]$ are given by:

\begin{GRAMMAR}
  \phi 
     &::=& 
  \top \fOr \phi_1 \land \phi_2  \fOr \langle a \rangle \phi \fOr \fBang A 
\end{GRAMMAR}
