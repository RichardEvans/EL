...
Now:
\begin{eqnarray}
\mathsf{neg}(y, \langle a \rangle (\langle b \rangle \top \AND \langle c \rangle \top)) & = & \nonumber \\
...
\[
\phi ::= \top \fOr \phi_1 \AND \phi_2  \fOr \langle a \rangle \phi
\]
...
\[
\phi ::= \top \fOr Arr_{s}(x_1, x_2)\fOr Restrict_A(x_1) \fOr \phi_1 \AND \phi_2 \fOr \exists x_1 . \phi 
\]
...
\[
\phi ::= \top \fOr \phi_1 \AND \phi_2 \fOr \langle s \rangle \phi \fOr \neg \phi 
\]
\subsection{Semantics}
